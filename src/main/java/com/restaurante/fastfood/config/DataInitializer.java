...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createProducts() {
        List<Product> products = Arrays.asList(
                ...
                new Product(null, "Pizza Margarita", "Pizza tradicional con salsa de tomate, mozzarella y albahaca", new BigDecimal("10.99"), "https://via.placeholder.com/300x200?text=Pizza+Margarita", true, "Quesadillas"),
                new Product(null, "Pizza Pepperoni", "Pizza con abundante pepperoni y queso mozzarella", new BigDecimal("12.99"), "https://via.placeholder.com/300x200?text=Pizza+Pepperoni", true, "Quesadillas"),
                new Product(null, "Pizza Hawaiana", "Pizza con jamón, piña y queso mozzarella", new BigDecimal("11.99"), "https://via.placeholder.com/300x200?text=Pizza+Hawaiana", true, "Quesadillas"),
